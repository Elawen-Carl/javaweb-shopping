...
! function(t) {
	...
	r.prototype.cache = n, r.prototype.define = function(t, e) {
		...
		function c(t, e) {
			...
			("load" === t.type || r.test((t.currentTarget || t.srcElement).readyState)) && (n.modules[d] = e, y.removeChild(m),
				function o() {
					return ++v > 1e3 * n.timeout / 4 ? a(d + " is not a valid module", "error") : void(n.status[d] ? s() : setTimeout(
						o, 4))
				}())
		}
		...
		var d = t[0],
			v = 0;
		if (l = l || [], n.host = n.host || (f.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0], 0 === t.length ||
			layui["layui.all"] && u[d]) return s(), p;
		...
		if (h = h.replace(/^\{\/\}/, ""), !n.modules[d] && layui[d] && (n.modules[d] = h), n.modules[d]) ! function g() {
			return ++v > 1e3 * n.timeout / 4 ? a(d + " is not a valid module", "error") : void("string" == typeof n.modules[d] &&
				n.status[d] ? s() : setTimeout(g, 4))
		}();
		else {
			...
			m.async = !0, m.charset = "utf-8", m.src = h + function() {
					...
					return t ? "?v=" + t : ""
				}(), y.appendChild(m), !m.attachEvent || m.attachEvent.toString && m.attachEvent.toString().indexOf("[native code") <
				0 || i ? m.addEventListener("load", function(t) {
					c(t, h)
		...
		var c = (o || t).replace(/\.|\//g, ""),
			s = u.id = "layuicss-" + c,
			p = 0;
		return u.rel = "stylesheet", u.href = t + (n.debug ? "?v=" + (new Date).getTime() : ""), u.media = "all", e.getElementById(
			s) || l.appendChild(u), "function" != typeof r ? i : (function f() {
			return ++p > 1e3 * n.timeout / 100 ? a(t + " timeout") : void(1989 === parseInt(i.getStyle(e.getElementById(s),
				"width")) ? function() {
				r()
			}() : setTimeout(f, 100))
		}(), i)
		...
		return "LAYUI-EVENT-REMOVE" === r ? (delete(a.cache.event[l] || {})[c], a) : o ? (n.event[l] = n.event[l] || {}, n.event[
			l][c] = [o], this) : (layui.each(n.event[l], function(t, e) {
...
! function() {
	...
	var t = "lay",
		...
		r = function(t) {
			for (var n = 0, r = "object" == typeof t ? [t] : (this.selector = t, e.querySelectorAll(t || null)); n < r.length; n++)
				this.push(r[n])
		};
	r.prototype = [], r.prototype.constructor = r, n.extend = function() {
		...
		var u = (o || t).replace(/\.|\//g, ""),
			a = "layuicss-" + u,
			s = 0;
		c.rel = "stylesheet", c.href = t, c.id = a, e.getElementById(a) || i.appendChild(c), "function" == typeof r && !
			function l() {
				return ++s > 80 ? window.console && console.error(u + ".css: Invalid") : void(1989 === parseInt(n.getStyle(e.getElementById(
					a), "width")) ? r() : setTimeout(l, 100))
			}()
		...
		if (r) {
			...
			var i = "right" === o.clickType ? function() {
				...
				f = i.left,
				p = i.bottom;
			f + c + l > s("width") && (f = s("width") - c - l), p + u + l > s() && (i.top > u + l ? p = i.top - u - 2 * l :
				"right" === o.clickType && (p = s() - u - 2 * l, p < 0 && (p = 0)));
			var h = o.position;
			if (h && (r.style.position = h), r.style.left = f + ("fixed" === h ? 0 : a(1)) + "px", r.style.top = p + ("fixed" ===
					h ? 0 : a()) + "px", !n.hasScrollbar()) {
...
! function(e) {
	...
	v.isLeapYear = function(e) {
		...
		a.elem = lay(a.elem), a.eventElem = lay(a.eventElem), a.elem[0] && (a.range === !0 && (a.range = "-"), i[a.type] ||
			(e.console && console.error && console.error("laydate type error:'" + a.type + "' is not supported"), a.type =
				"date"), a.format === i.date && (a.format = i[a.type] || i.date), t.format = a.format.match(new RegExp(n + "|.",
				"g")) || [], t.EXP_IF = "", t.EXP_SPLIT = "", lay.each(t.format, function(e, a) {
				var l = new RegExp(n).test(a) ? "\\d{" + function() {
					return new RegExp(n).test(t.format[0 === e ? e + 1 : e - 1] || "") ? /^yyyy|y$/.test(a) ? 4 : a.length :
						/^yyyy$/.test(a) ? "1,4" : /^y$/.test(a) ? "1,308" : "1,2"
				}() + "}" : "\\" + a;
				t.EXP_IF = t.EXP_IF + l, t.EXP_SPLIT = t.EXP_SPLIT + "(" + l + ")"
			}), t.EXP_IF = new RegExp("^" + (a.range ? t.EXP_IF + "\\s\\" + a.range + "\\s" + t.EXP_IF : t.EXP_IF) + "$"), t.EXP_SPLIT =
			new RegExp("^" + t.EXP_SPLIT + "$", ""), t.isInput(a.elem[0]) || "focus" === a.trigger && (a.trigger = "click"), a
			.elem.attr("lay-key") || (a.elem.attr("lay-key", t.index), a.eventElem.attr("lay-key", t.index)), a.mark = lay.extend({},
			...
			}), t.elemID = "layui-laydate" + a.elem.attr("lay-key"), (a.show || l) && t.render(), l || t.events(), a.value &&
			a.isInitValue && (a.value.constructor === Date ? t.setValue(t.parse(0, t.systemDate(a.value))) : t.setValue(a.value))
		)
		...
		var e = this,
			...
			l = e.elem = lay.elem("div", {
				id: e.elemID,
				"class": ["layui-laydate", t.range ? " layui-laydate-range" : "", n ? " " + d : "", t.theme && "default" !== t.theme &&
		...
		if (t.zIndex && (l.style.zIndex = t.zIndex), lay.each(new Array(2), function(e) {
				...
				var e = [],
					l = [];
				return "datetime" === t.type && e.push('<span lay-type="datetime" class="laydate-btns-time">' + a.timeTips +
					"</span>"), lay.each(t.btns, function(e, i) {
					var r = a.tools[i] || "btn";
					t.range && "now" === i || (n && "clear" === i && (r = "cn" === t.lang ? "重置" : "Reset"), l.push(
						'<span lay-type="' + i + '" class="laydate-btns-' + i + '">' + r + "</span>"))
			...
			"styleSheet" in m ? (m.setAttribute("type", "text/css"), m.styleSheet.cssText = c) : m.innerHTML = c, lay(l).addClass(
				"laydate-theme-molv"), l.appendChild(m)
		}
		e.remove(v.thisElemDate), n ? t.elem.append(l) : (document.body.appendChild(l), e.position()), e.checkDate().calendar(
			null, 0, "init"), e.changeEvent(), v.thisElemDate = e.elemID, "function" == typeof t.ready && t.ready(lay.extend({},
			t.dateTime, {
		...
		t.elem && (a.innerHTML = e || "", lay(t.elem).find("." + u).remove(), t.elem.appendChild(a), clearTimeout(t.hinTimer),
		...
		var t, a, l = this,
			...
			m = function(e) {
				e.year > y[1] && (e.year = y[1], a = !0), e.month > 11 && (e.month = 11, a = !0), e.hours > 23 && (e.hours = 0, a = !
			...
			c = function(e, t, n) {
				...
				t = (t.match(l.EXP_SPLIT) || []).slice(1), n = n || 0, i.range && (l[r[n]] = l[r[n]] || {}), lay.each(l.format,
					function(o, s) {
						var d = parseFloat(t[o]);
						t[o].length < s.length && (a = !0), /yyyy|y/.test(s) ? (d < y[0] && (d = y[0], a = !0), e.year = d) : /MM|M/.test(
								s) ? (d < 1 && (d = 1, a = !0), e.month = d - 1) : /dd|d/.test(s) ? (d < 1 && (d = 1, a = !0), e.date = d) :
							/HH|H/.test(s) ? (d < 1 && (d = 0, a = !0), e.hours = d, i.range && (l[r[n]].hours = d)) : /mm|m/.test(s) ? (d <
								1 && (d = 0, a = !0), e.minutes = d, i.range && (l[r[n]].minutes = d)) : /ss|s/.test(s) && (d < 1 && (d = 0,
								a = !0), e.seconds = d, i.range && (l[r[n]].seconds = d))
					}), m(e)
			};
		return "limit" === e ? (m(o), l) : (d = d || i.value, "string" == typeof d && (d = d.replace(/\s+/g, " ").replace(
				/^\s|\s$/g, "")), i.range && (l.endDate = l.endDate || lay.extend({}, o, function() {
				var e = {},
					t = l.getAsYM(o.year, o.month);
				return "year" === i.type ? e.year = o.year + 1 : "time" !== i.type && (e.year = t[0], e.month = t[1]), e
			}())), "string" == typeof d && d ? l.EXP_IF.test(d) ? i.range ? (d = d.split(" " + i.range + " "), lay.each([i.dateTime,
				l.endDate
			], function(e, t) {
				c(t, d[e], e)
			})) : c(o, d) : (l.hint(r.formatError[0] + (i.range ? i.format + " " + i.range + " " + i.format : i.format) + r.formatError[
				1]), a = !0) : d && d.constructor === Date ? i.dateTime = l.systemDate(d) : (i.dateTime = l.systemDate(), delete l
				.startTime, delete l.endTime), m(o), a && d && l.setValue(i.range ? l.endDate ? l.parse() : "" : l.parse()), e &&
			e(), l)
		...
		return m.year < y[0] && (m.year = y[0], s.hint(u.invalidDate)), m.year > y[1] && (m.year = y[1], s.hint(u.invalidDate)),
			s.firstDate || (s.firstDate = lay.extend({}, m)), c.setFullYear(m.year, m.month, 1), l = c.getDay(), i = n.getEndDate(
				m.month || 12, m.year), r = n.getEndDate(m.month + 1, m.year), lay.each(p, function(e, t) {
				var a = [m.year, m.month],
					n = 0;
				t = lay(t), t.removeAttr("class"), e < l ? (n = i - l + e, t.addClass("laydate-day-prev"), a = s.getAsYM(m.year,
					m.month, "sub")) : e >= l && e < r + l ? (n = e - l, n + 1 === m.date && t.addClass(o)) : (n = e - r - l, t.addClass(
					"laydate-day-next"), a = s.getAsYM(m.year, m.month)), a[1]++, a[2] = n + 1, t.attr("lay-ymd", a.join("-")).html(
					a[2]), s.mark(t, a).limit(t, {
					year: a[0],
					month: a[1] - 1,
					date: a[2]
				}, e)
			}), lay(g[0]).attr("lay-ym", m.year + "-" + (m.month + 1)), lay(g[1]).attr("lay-ym", m.year + "-" + (m.month + 1)),
			"cn" === d.lang ? (lay(g[0]).attr("lay-type", "year").html(m.year + "年"), lay(g[1]).attr("lay-type", "month").html(
				m.month + 1 + "月")) : (lay(g[0]).attr("lay-type", "month").html(u.month[m.month]), lay(g[1]).attr("lay-type",
				"year").html(m.year)), h && (d.range ? e && (s.listYM = [
				[d.dateTime.year, d.dateTime.month + 1],
				[s.endDate.year, s.endDate.month + 1]
			], s.list(d.type, 0).list(d.type, 1), "time" === d.type ? s.setBtnStatus("时间", lay.extend({}, s.systemDate(), s.startTime),
				lay.extend({}, s.systemDate(), s.endTime)) : s.setBtnStatus(!0)) : (s.listYM = [
				[m.year, m.month + 1]
			], s.list(d.type, 0))), d.range && "init" === a && !e && s.calendar(s.endDate, 1), d.range || s.limit(lay(s.footer)
				.find(f), null, 0, ["hours", "minutes", "seconds"]), s.setBtnStatus(), s.stampRange(t, p), s
		...
		if (D[0] < 1 && (D[0] = 1), "year" === e) {
			...
			w < 1 && (w = C = 1), lay.each(new Array(15), function(e) {
				...
				C == D[0] && lay(l).addClass(o), l.innerHTML = C + T, y.appendChild(l), C < a.firstDate.year ? (i.month = n.min.month,
					i.date = n.min.date) : C >= a.firstDate.year && (i.month = n.max.month, i.date = n.max.date), a.limit(lay(l),
					i, t), C++
			...
			e + 1 == D[1] && lay(l).addClass(o), l.innerHTML = i.month[e] + (v ? "月" : ""), y.appendChild(l), D[0] < a.firstDate
				.year ? r.date = n.min.date : D[0] >= a.firstDate.year && (r.date = n.max.date), a.limit(lay(l), r, t)
		...
		if (h && u.removeChild(h), u.appendChild(y), "year" === e || "month" === e) lay(a.elemMain[t]).addClass(
			...
			if (!lay(this).hasClass(s)) {
				...
				d ? (lay(y).find("." + o).removeClass(o), lay(this).addClass(o), "month" === n.type && "year" === e && (a.listYM[
					t][0] = i, r && (t ? l.year = i : a.endDate.year = i), a.list("month", t))) : (a.checkDate("limit").calendar(
					null, t), a.closeList()), a.setBtnStatus(), n.range || (("month" === n.type && "month" === e || "year" === n.type &&
					"year" === e) && a.setValue(a.parse()).remove().done(), a.done(null, "change")), lay(a.footer).find(g).removeClass(
					s)
			}
		});
		else {
			...
			b(), E.innerHTML = n.range ? [i.startTime, i.endTime][t] : i.timeTips, lay(a.elemMain[t]).addClass(
				"laydate-time-show"), H[0] && H.remove(), d[2].appendChild(E), lay(y).find("ol").each(function(e) {
				var t = this;
				lay(t).find("li").on("click", function() {
					var i = 0 | this.innerHTML;
					lay(this).hasClass(s) || (n.range ? a[x][M[e]] = i : l[M[e]] = i, lay(t).find("." + o).removeClass(o), lay(
						this).addClass(o), k(), b(), (a.endDate || "time" === n.type) && a.done(null, "change"), a.setBtnStatus())
				})
			})
		}
		return a
		...
		i.range && "time" !== i.type && (t = t || i.dateTime, a = a || l.endDate, n = l.newDate(t).getTime() > l.newDate(a).getTime(),
			l.limit(null, t) || l.limit(null, a) ? o.addClass(s) : o[n ? "addClass" : "removeClass"](s), e && n && l.hint(
		...
		return lay.each(i, function(e, t) {
			/yyyy|y/.test(t) ? i[e] = lay.digit(l.year, t.length) : /MM|M/.test(t) ? i[e] = lay.digit(l.month + 1, t.length) :
				/dd|d/.test(t) ? i[e] = lay.digit(l.date, t.length) : /HH|H/.test(t) ? i[e] = lay.digit(l.hours, t.length) :
				/mm|m/.test(t) ? i[e] = lay.digit(l.minutes, t.length) : /ss|s/.test(t) && (i[e] = lay.digit(l.seconds, t.length))
		...
		i = {
			...
			}), a.calendar(null, t)) : "static" === n.position ? a.calendar().done().done(null, "change") : "date" === n.type ?
			a.setValue(a.parse()).remove().done() : "datetime" === n.type && a.calendar().done(null, "change"))
		...
		var a = this,
			...
			o = {
				datetime: function() {
					lay(e).hasClass(s) || (a.list("time", 0), n.range && a.list("time", 1), lay(e).attr("lay-type", "date").html(a.lang()
						.dateTips))
				},
				date: function() {
				...
				clear: function() {
					a.setValue("").remove(), r && (lay.extend(i, a.firstDate), a.calendar()), n.range && (delete a.endDate, delete a
						.startTime, delete a.endTime), a.done(["", {}, {}])
				},
				now: function() {
					var e = new Date;
		...
		a.elem[0] && !a.elem[0].eventHandler && (n(a.elem, "bind"), n(a.eventElem), lay(document).on("click", function(e) {
			...
			13 === e.keyCode && lay("#" + t.elemID)[0] && t.elemID === v.thisElemDate && (e.preventDefault(), lay(t.footer).find(
				f)[0].click())
	...
	var t = layui.$,
		i = {
			fixbar: function(e) {
				...
				var c = [e.bar1, e.bar2, "&#xe604;"],
					g = t(['<ul class="' + n + '">', e.bar1 ? '<li class="layui-icon" lay-type="bar1" style="' + e.bgcolor + '">' +
			...
			timeAgo: function(e, t) {
				...
				return n > 26784e5 ? (n = new Date(e), a[0][0] = i.digit(n.getFullYear(), 4), a[0][1] = i.digit(n.getMonth() + 1),
						a[0][2] = i.digit(n.getDate()), t || (a[1][0] = i.digit(n.getHours()), a[1][1] = i.digit(n.getMinutes()), a[1]
							[2] = i.digit(n.getSeconds())), a[0].join("-") + " " + a[1].join(":")) : n >= 864e5 ? (n / 1e3 / 60 / 60 / 24 |
						0) + "天前" : n >= 36e5 ? (n / 1e3 / 60 / 60 | 0) + "小时前" : n >= 18e4 ? (n / 1e3 / 60 | 0) + "分钟前" : n < 0 ?
					"未来" : "刚刚"
			},
			digit: function(e, t) {
				var i = "";
			...
			toDateString: function(e, t) {
				...
				return t = t || "yyyy-MM-dd HH:mm:ss", t.replace(/yyyy/g, n[0]).replace(/MM/g, n[1]).replace(/dd/g, n[2]).replace(
			...
			event: function(e, a, n) {
				var o = t("body");
				return n = n || "click", a = i.event[e] = t.extend(!0, i.event[e], a) || {}, i.event.UTIL_EVENT_CALLBACK = i.event
					.UTIL_EVENT_CALLBACK || {}, o.off(n, "*[" + e + "]", i.event.UTIL_EVENT_CALLBACK[e]), i.event.UTIL_EVENT_CALLBACK[
						e] = function() {
						var i = t(this),
							n = i.attr(e);
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
	...
	I.prototype.config = {
			...
			if (a.index = e.index, e.key = a.id || a.index, n[0] && n.remove(), l.after(o), e.layTool = o.find(m), e.layBox =
				...
				o.find(T), e.layFixRight = o.find(N), e.layTotal = o.find(A), e.layPage = o.find(L), e.renderToolbar(), e.fullSize(),
				a.cols.length > 1) {
			...
			var a = this;
			e = e || {}, delete a.haveInit, e.data && e.data.constructor === Array && delete a.config.data, a.config = t.extend(
				i, {}, a.config, e), a.render()
				...
				l.eachCols(function(e, d) {
					var c = d.field || e,
						...
						y = ['<td data-field="' + c + '" data-key="' + n.index + "-" + d.key + '" ' + function() {
							var e = [];
							return d.align && e.push('align="' + d.align + '"'), d.style && e.push('style="' + d.style + '"'), d.minWidth &&
								e.push('data-minwidth="' + d.minWidth + '"'), e.join(" ")
						}() + ' class="' + function() {
							var e = [];
			...
			var e, t = this,
				i = t.config,
				a = i.height;
			t.fullHeightGap && (a = j.height() - t.fullHeightGap, a < 135 && (a = 135), t.elem.css("height", a)), a && (e =
