            ...
            <form id="comment-reply-form" class="b-form" method="post" action="userServlet">
                ...
                <div class="form-group">
                    <div class="row justify-content-around">
                        ...
                        <div class="col-sm-12" style="text-align:center;">
                            <p class="h2" style="font-weight: normal; text-transform: uppercase;"> login </p>
                        </div>
                        <div class="col-sm-12" style="text-align:center;">
                            <div class="row-space-20"></div>
                        </div>
                        ...
                        <div class="col-sm-12 text-center">
                            <button type="submit" style="text-transform: uppercase;" class="btn btn-primary px-5">login in</button>
                        </div>
                        <div class="col-sm-12" style="text-align:center;">
                            <div class="row-space-20"></div>
                        </div>
